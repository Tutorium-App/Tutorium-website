...
import {
  ...
  useSlotProps,
  useTheme
} from "./chunk-TSOEBLGO.js";
import {
  init_useControlled,
  init_useId,
  useControlled_default,
  useId_default
} from "./chunk-T4JQEQUH.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-JJPSI3CS.js";
import {
...
var Tooltip = React6.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React6.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime6.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime7.jsxs)(React6.Fragment, {
    children: [React6.cloneElement(children, childrenProps), (0, import_jsx_runtime6.jsx)(PopperComponent, _extends({
